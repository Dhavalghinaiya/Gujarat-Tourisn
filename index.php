...
<html lang="en">
	<?php      
		...
		if ($conn->connect_error) {
		  ...
		  $sql = "select * from user_data where email = '$email' and u_password = '$upass'";  
            ...
            <div class="screen__content">
                <form class="login" method="post">
                    ...
                    <div class="login__field">
                        ...
                        <input type="password" class="login__input" placeholder="Password" name="upass">
                    </div>
					...
					<table style="margin:5px;">
						...
						<tr>
							<td>
								<p>Don't have Account?<a href="Signup.php">Create An Acoount</a></p>
